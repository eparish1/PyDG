...
from timeSchemes import *#advanceSol,advanceSolImplicit4,advanceSolImplicitPC
import time
...
CFL = 10.*dt/dx
CFLp = 10.*dt/(dx/order)
print('CFL = ' + str(CFL), 'CFLp = ' + str(CFLp))
et = 10.
iteration = 0
save_freq = 1
...
while (main.t <= main.et - main.dt/2):
  ...
  advanceSolImplicit_MG(main,main,eqns,schemes)
reconstructU(main,main.a)
uG = gatherSolSlab(main,eqns,main.a)
if (main.mpi_rank == 0):
