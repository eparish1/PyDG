...
MZ =   variables(Nel,order,quadpoints,eqns,mu,x,y,z,t,et,dt,iteration,save_freq,schemes,'DNS',procx,procy)

xG,yG,zG = getGlobGrid(x,y,z,main.zeta)
xG2,yG2,zG2 = getGlobGrid2(x,y,z,main.zeta)
np.savez('DGgrid',x=xG,y=yG,z=zG)

getIC2(main,TGVIC2,xG2[:,:,:,main.sx,main.sy,:],yG2[:,:,:,main.sx,main.sy,:],zG2[:,:,:,main.sx,main.sy,:])
