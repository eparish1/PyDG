...
dy = 2*np.pi/(128.)
dz = 2*np.pi/(128.)
xg = np.linspace(0,2.*np.pi-dx,128.)
yg = np.linspace(0,2.*np.pi-dy,128.)
zg = np.linspace(0,2.*np.pi-dz,128.)
...
Minf = 0.2
L = 2.*np.pi                       #|  length
Nel = np.array([8,8,8])   #|  elements in x,y,z
order = np.array([8,8,8])                         #|  spatial order
