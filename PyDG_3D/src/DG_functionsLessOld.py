...
def getRHS_IPNew(main,MZ,eqns,args=[]):
  t0 = time.time()
  reconstructU(main,main.a)
  # evaluate inviscid flux
  getFlux(main,MZ,eqns,args)
  ...
  fvGX,fvGY,fvGZ,fvRIG11,fvLIG11,fvRIG21,fvLIG21,fvRIG31,fvLIG31,fvUIG12,fvDIG12,fvUIG22,fvDIG22,fvUIG32,fvDIG32,fvFIG13,fvBIG13,fvFIG23,fvBIG23,fvFIG33,fvBIG33,fvR2I,fvL2I,fvU2I,fvD2I,fvF2I,fvB2I = getViscousFlux(main,eqns) ##takes roughly 20% of the time
  # Now form RHS
  t1 = time.time()
  ord_arr0= np.linspace(0,main.order[0]-1,main.order[0])
  ord_arr1= np.linspace(0,main.order[1]-1,main.order[1])
...
def getViscousFluxNew(main,eqns):
  gamma = 1.4
  Pr = 0.72
  a = main.a.a
